...
type IconName = "journey" | "generator" | "library" | "framework";
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16">
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <ModuleCard
          icon="framework"
          title="Value-to-Scale Framework"
          description="The FDE delivery lifecycle. Move from business evidence to governed, scalable delivery without losing traceability."
          cta="Explore the framework"
          onOpen={onOpenFramework}
        />
        <ModuleCard
          icon="journey"
          title="FDE Journey"
          description="The FORGE FDE learning path — ten modules, from operating model through spec-driven delivery."
        ...
        <ModuleCard
          ...
          description="Upload a use case and run it through the reviewed delivery pipeline — each stage generated and scored."
